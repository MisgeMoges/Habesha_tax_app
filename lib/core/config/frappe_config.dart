class FrappeConfig {
  ...
  static const String baseUrl = String.fromEnvironment(
    'FRAPPE_BASE_URL',
    defaultValue: 'http://192.168.228.68:8000',
  ...
  static const String transactionAttachmentsField = 'attachments';
